...
BATCH_SIZE = 256             #how many records to use when doing one pass of gradient decent. Use a smaller number if your gpu is running out of memory.
...
#SAVE_MODEL_AS_H5 = True         # if old keras format should be used instead of savedmodel
...
PRUNE_PERCENT_TARGET = 24       # The desired percentage of pruning.
PRUNE_PERCENT_PER_ITERATION = 10 # Percenge of pruning that is perform per iteration.
...
#TRANSFORMATIONS = ['CANNY']       # changes applied _before_ training augmentations,
#                            # such that augmentations are applied to the transformed image,
POST_TRANSFORMATIONS = ['CUSTOM_CROP']  # transformations applied _after_ training augmentations,
#                            # such that changes are applied to the augmented image
# 
# # Settings for brightness and blur, use 'MULTIPLY' and/or 'BLUR' in
# # AUGMENTATIONS
#AUG_BRIGHTNESS_RANGE = 0.4  # this is interpreted as [-0.2, 0.2]
# AUG_BLUR_RANGE = (0, 3)
# 
# # "CROP" Transformation
...
CUSTOM_CROP_SRC = np.float32([(10, 69), (150, 73), (118, 60), (35, 60)])
CUSTOM_CROP_DST = np.float32([(40, 120), (120, 120), (120, 0), (40, 0)])
ROI_CROP_TOP = 30               # the number of rows of pixels to ignore on the top of the image
...
CANNY_LOW_THRESHOLD = 200    # Canny edge detection low threshold value of intensity gradient
CANNY_HIGH_THRESHOLD = 255  # Canny edge detection high threshold value of intensity gradient
...
BLUR_KERNEL = 3        # blur kernel horizontal size in pixels
